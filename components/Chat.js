    ...
    <>
      <div className={styles.chat}>
        <div className={styles.flexBetween}>
          <p className={styles.boldText}>Live Shiba</p>
          ...
          <div className={styles.flexBetween}>
            <div className={styles.flexCenter}>
              ...
              <div className="mr-10 text-left">
                <b>Prashant</b>
                <p className="test-gray-400">dfbksjdfhdsfgji</p>
              </div>
            </div>
            <div className={styles.flexCenter}>
              <div
      ...
      <input className={styles.input} placeholder="BTC..." value={message} onChange={e => setMessage(e.target.value)}/>
